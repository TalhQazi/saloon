...
$outputPath = "d:\saloon\mono_logo_centered.png"
$base64Path = "d:\saloon\new_logo_mono_base64.txt"
# Set to 384, which is the exact printable dot width for most 58mm printers.
# This ensures it fits perfectly.
$targetWidth = 384
...
if (Test-Path $inputPath) {
    try {
        ...
        Write-Host "Success: Resized to 384px for perfect centering. Size: $($targetWidth)x$($targetHeight)"
    } catch {
        Write-Host "Error: $_"
        exit 1
    }
