...
const AddProductDetailModal = ({
    ...
    const handleSave = () => {
        // Updated validation: require name, price, and image
        if (!productDetailName || !price || !imageUri) {
            Alert.alert(
                'Missing Information',
                'Please fill in all required fields and add an image (Product Item Name, Price, Image).',
            );
            return;
        }
