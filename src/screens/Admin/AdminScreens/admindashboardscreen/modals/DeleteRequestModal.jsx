...
const DeleteRequestModal = ({ isVisible, onClose, onDelete, requestDetails }) => {
    return (
        <Modal
            animationType="fade"
            transparent={true}
                ...
                <View style={styles.modalOverlay}>
                    <TouchableWithoutFeedback>
                        <View style={styles.modalContent}>
                            ...
                            {/* Optionally display request details here if needed for confirmation */}
                            {requestDetails && (
                            ...
                            <View style={styles.modalButtons}>
                                ...
                                <TouchableOpacity style={styles.deleteButton} onPress={onDelete}>
                                    <Text style={styles.deleteButtonText}>Yes, Decline</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                    </TouchableWithoutFeedback>
...
const styles = StyleSheet.create({
    ...
    deleteButton: {
        backgroundColor: '#ff5555', // Red color for delete
        paddingVertical: height * 0.015,
        paddingHorizontal: width * 0.025,
        borderRadius: 8,
        flex: 1, // Make buttons take equal space
