...
const DealDetailModal = ({ visible, onClose, deal }) => {
    ...
    const mainImageSource = typeof (deal.image || deal.dealImage) === 'string'
        ? { uri: deal.image || deal.dealImage }
        : (deal.image || deal.dealImage);
                ...
                <View style={detailStyles.modalContainer}>
                    ...
                    <ScrollView contentContainerStyle={detailStyles.scroll}>
                        ...
                        <Text style={detailStyles.detailText}>
                            {deal.name || deal.dealName || deal.title || 'N/A'}
                        </Text>

                        <Text style={detailStyles.detailLabel}>Price:</Text>
                        <Text style={detailStyles.detailText}>PKR {deal.price != null ? deal.price : '0'}</Text>
