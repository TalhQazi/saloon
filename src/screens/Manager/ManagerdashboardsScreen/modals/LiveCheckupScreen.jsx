...
const LiveCheckupScreen = ({ navigation }) => {
      ...
      >
        <View style={styles.content}>
          ...
          <Text style={styles.timerText}>
            You have <Text style={styles.boldText}>5 minutes</Text> to complete the follow
            instruction for <Text style={styles.boldText}>move</Text> or{' '}
            <Text style={styles.boldText}>speak</Text>
          </Text>
...
export default LiveCheckupScreen;
